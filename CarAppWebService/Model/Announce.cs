namespace CarAppWebService.Model
{
    ...
    {
        public string marca, model, varianta, caroserie, combustibil, cutieViteze, culoare, dataAnunt, locatie, descriere, telefon;
        ...
        public Announce(int idAnunt,int idUser, string marca, string model, string caroserie, string varianta, int pret, int an, int km, int putere, int putereKw, string combustibil, string cutieViteze,
            int cc, string culoare, string dataAnunt, string locatie, string telefon, string descriere, byte[] imagAnunt, byte[] imag1, byte[] imag2, byte[] imag3)
        {
